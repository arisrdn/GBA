...
//         };
//         fetch(API + "messages/p", requestOptions)
...
//                             <Link to="/chat/p" className="nav-link active">
//                                 User
//                             </Link>
//                         </li>
//                         <li className="nav-item">
//                             <Link to="/chat/g" className="nav-link ">
//                                 Group
//                             </Link>
//                         </li>
//                     </ol>
